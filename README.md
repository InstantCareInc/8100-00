...
| **Output image** | [`8100-00-704.hex`](https://github.com/InstantCareInc/8100-00/releases/download/v7.04/8100-00-704.hex) ([v7.04 release](https://github.com/InstantCareInc/8100-00/releases/tag/v7.04)) |
...
|---------|------------|-------------|---------|
| **7.04** | `v704` | 700 | Forked from v6.16. Toolchain migration from IAR Embedded Workbench to Code Composer Studio; no functional firmware changes from v6.16. Does not include the v6.20 `TIMEOUT_REMOTE_RS485_INPUT` change. |
