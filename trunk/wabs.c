...
struct alert_data *active_alert_head[MAX_VALID_HOST_RS485_ADDRESS] = NULL;    // Pointer to the oldest item in the selected  alert list.
struct alert_data *active_alert_tail[MAX_VALID_HOST_RS485_ADDRESS] = NULL;    // Pointer to the newest item in the selected alert list.  This is what's used to add entries to the list.
